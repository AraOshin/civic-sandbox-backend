...
HOUSING_AFFORDABILITY_18_POSTGRES_HOST=`aws ssm get-parameters --names "$NAMESPACE"/"$PROJECT_CANONICAL_NAME"/HOUSING_AFFORDABILITY_18_POSTGRES_HOST --no-with-decryption --region $EC2_REGION --output text | awk '{print $4}'`
HOUSING_AFFORDABILITY_18_POSTGRES_NAME=`aws ssm get-parameters --names "$NAMESPACE"/"$PROJECT_CANONICAL_NAME"/HOUSING_AFFORDABILITY_18_POSTGRES_NAME --no-with-decryption --region $EC2_REGION --output text | awk '{print $4}'`
HOUSING_AFFORDABILITY_18_POSTGRES_PORT=`aws ssm get-parameters --names "$NAMESPACE"/"$PROJECT_CANONICAL_NAME"/HOUSING_AFFORDABILITY_18_POSTGRES_PORT --no-with-decryption --region $EC2_REGION --output text | awk '{print $4}'`
HOUSING_AFFORDABILITY_18_POSTGRES_USER=`aws ssm get-parameters --names "$NAMESPACE"/"$PROJECT_CANONICAL_NAME"/HOUSING_AFFORDABILITY_18_POSTGRES_USER --no-with-decryption --region $EC2_REGION --output text | awk '{print $4}'`
...
HOUSING_AFFORDABILITY_18_POSTGRES_PASSWORD=`aws ssm get-parameters --names "$NAMESPACE"/"$PROJECT_CANONICAL_NAME"/HOUSING_AFFORDABILITY_18_POSTGRES_PASSWORD --with-decryption --region $EC2_REGION --output text | awk '{print $4}'`
...
export HOUSING_AFFORDABILITY_18_POSTGRES_HOST=$HOUSING_AFFORDABILITY_18_POSTGRES_HOST
export HOUSING_AFFORDABILITY_18_POSTGRES_NAME=$HOUSING_AFFORDABILITY_18_POSTGRES_NAME
export HOUSING_AFFORDABILITY_18_POSTGRES_PASSWORD=$HOUSING_AFFORDABILITY_18_POSTGRES_PASSWORD
export HOUSING_AFFORDABILITY_18_POSTGRES_USER=$HOUSING_AFFORDABILITY_18_POSTGRES_USER