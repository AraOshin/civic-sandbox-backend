...
class Crash(models.Model):
    ...
    geom = models.PointField(db_column='geom_point', null=True)
...
class BlockChange(models.Model):
    ...
    geom = models.PolygonField(db_column='hull_4326', null=True)
...
class RouteChange(models.Model):
    ...
    geom = models.LineStringField(db_column='geom_linestring', null=True)
